...
/*
  Modifications made by the JTeam for CPX Utilities
*/
...
CPX.experilousSetup = function () {
  ...
  return new Promise(function(resolve,reject){
    ...
    ui.rendererElement.addClass('full');
...
function generatePlanetAsynchronous(VU)
{
	var planet;
	...
	activeAction = new SteppedAction(updateProgressUI)
		...
		.finalize(function(action) { 
		  activeAction = null; ui.progressPanel.hide(); 
		  //added to compute mods to planet
		  VU.applyMods();
		}, 0)
		.execute();
}
...
{
  //using the vue
  if(CPX.EXP.latdelta != 0){
    var ld = CPX.EXP.latdelta;
    CPX.EXP.latdelta = 0;
    return ld;
  }
...
{
  //using the vue
  if(CPX.EXP.longdelta != 0){
    var ld = CPX.EXP.longdelta;
    CPX.EXP.longdelta = 0;
    return ld;
  }
